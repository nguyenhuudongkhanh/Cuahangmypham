...
namespace WebBanHangOnline.Models
{
    public partial class BanHangOnlineContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-FF1278R;Database=BanHangOnline;Integrated Security=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>(entity =>
            {
                entity.HasKey(e => e.CatId)
                    .HasName("PK__Categori__6A1C8ADA46185269");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                entity.HasKey(e => e.CustomersId)
                    .HasName("PK__Customer__EB5B581ED4D0844B");
            ...
            modelBuilder.Entity<News>(entity =>
            {
                entity.HasKey(e => e.PostId)
                    .HasName("PK__News__AA126038821E34BF");
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                entity.HasKey(e => e.OrdersId)
                    .HasName("PK__Orders__630B9956A6137554");
            ...
            modelBuilder.Entity<OrdersDetail>(entity =>
            {
                entity.HasKey(e => e.OrdersDetailsId)
                    .HasName("PK__OrdersDe__4345BE56CFDAEA0C");
            ...
            modelBuilder.Entity<Page>(entity =>
            {
                entity.HasKey(e => e.Pages)
                    .HasName("PK__Pages__ED67F51B48769059");
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                entity.HasKey(e => e.ProductsId)
                    .HasName("PK__Products__BB48EDC5822240E8");
